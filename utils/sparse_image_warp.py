...
def sparse_image_warp(image,
  ...
  with ops.name_scope(name):
    ...
    batch_size, image_depth, image_height, image_width, _ = (
      image.get_shape().as_list())

    # This generates the dense locations where the interpolant
    # will be evaluated.
    grid_locations = _get_grid_locations(image_depth, image_height,
                                         image_width)
    ...
    if clamp_boundaries:
      (dest_control_point_locations,
       control_point_flows) = _add_zero_flow_controls_at_boundary(
         dest_control_point_locations, control_point_flows, image_depth,
